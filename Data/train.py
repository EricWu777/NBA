...
class Train_data:
    ...
    def __init__(self, pastgame_num , games_data ):
    ...
    def rolling_data(self):
        ...
        train_data = self.games_data[(self.games_data.SEASON_ID.str[0]!='4') & (self.games_data.SEASON_ID.str[0]!='5')
                               & (self.games_data.SEASON_ID.str[0]!='6')]
